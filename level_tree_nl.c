...
void queue_pop(queue_t *q)
{
    ...
    if (q->n_memb > 1) {
        memmove(q->data, q->data + 1, sizeof(void *) * (q->n_memb - 1));
    }
...
int main()
{
   ...
   44          12   42
    ...
    node_t root = { NULL, NULL, 0, 8 };
    node_t l0 = { NULL, NULL, 0, 2 };
    node_t l1 = { NULL, NULL, 0, 7 };
    node_t l2 = { NULL, NULL, 0, 1 };
    node_t l3 = { NULL, NULL, 0, 3 };
    node_t l4 = { NULL, NULL, 0, 5 };
    node_t l5 = { NULL, NULL, 0, 9 };
    node_t l6 = { NULL, NULL, 0, 44 };
    node_t l7 = { NULL, NULL, 0, 12 };
    node_t l8 = { NULL, NULL, 0, 42 };
